...
Spawn code: cheat gfi PrimalItemConsumable_ImprintKibble 1 0 0
...
Description
==============
This mod adds an "Imprint Kibble" that can be learned at level 16 for 0 engram points and crafted in a cooking pot or industrial cooker. The Imprint Kibble costs 1 of each Kibble.
...
If fed to an adult female dinosaur, the kibble will provide a buff for a limited time. This buff will increase mutation chance, skip mating cooldown, reduce mating time, and increase gestation speed.

An option to set a cooldown after the kibble is used can also be enabled.
...
- ExtraMatureSpeed: The multiplier by which the baby dinosaur's maturation speed will increase. This will equal your BabyMatureSpeedMultiplier x ExtraMatureSpeed. Default: 2.0
...
- NumberOfMutations: The number of mutations a baby dinosaur can get. Further explanation below. Default: 1
...
- ExtraGestationInterval: The interval that the gestation time will increase by the ExtraGestationPercentage. Further explanation below. Default: 5.0
